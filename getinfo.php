...
//Alan : Syntax Error : remove extra ')'
...
// Object ID may not be always in index position = 1
...
# Invalid Class, there is no dataObj Class defined
# Assumption : for the purpose of testing, properData class has been assumpted.
...
# interpolation work on double quoted string, not singl quoted string
